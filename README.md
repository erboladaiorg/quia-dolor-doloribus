# `@erboladaiorg/quia-dolor-doloribus` <sup>[![Version Badge][npm-version-svg]][package-url]</sup>
...
```sh
npm install eslint @erboladaiorg/quia-dolor-doloribus --save-dev
```
...
If you are using the [new JSX transform from React 17](https://reactjs.org/blog/2020/09/22/introducing-the-new-jsx-transform.html#removing-unused-react-imports), extend [`react/jsx-runtime`](https://github.com/erboladaiorg/quia-dolor-doloribus/blob/c8917b0885094b5e4cc2a6f613f7fb6f16fe932e/index.js#L163-L176) in your eslint config (add `"plugin:react/jsx-runtime"` to `"extends"`) to disable the relevant rules.
...
**Note**: These configurations will import `@erboladaiorg/quia-dolor-doloribus` and enable JSX in [parser options](https://eslint.org/docs/user-guide/configuring/language-options#specifying-parser-options).
...
The default export of `@erboladaiorg/quia-dolor-doloribus` is a plugin object.

```js
const react = require('@erboladaiorg/quia-dolor-doloribus');
...
- `@erboladaiorg/quia-dolor-doloribus/configs/all`
- `@erboladaiorg/quia-dolor-doloribus/configs/recommended`
- `@erboladaiorg/quia-dolor-doloribus/configs/jsx-runtime`

If your eslint.config.js is ESM, include the `.js` extension (e.g. `@erboladaiorg/quia-dolor-doloribus/recommended.js`). Note that the next semver-major will require omitting the extension for these imports.

**Note**: These configurations will import `@erboladaiorg/quia-dolor-doloribus` and enable JSX in [`languageOptions.parserOptions`](https://eslint.org/docs/latest/user-guide/configuring/configuration-files-new#configuration-objects).
...
```js
const reactRecommended = require('@erboladaiorg/quia-dolor-doloribus/configs/recommended');
...
💼 [Configurations](https://github.com/erboladaiorg/quia-dolor-doloribus/#shareable-configs) enabled in.\
🚫 [Configurations](https://github.com/erboladaiorg/quia-dolor-doloribus/#shareable-configs) disabled in.\
🏃 Set in the `jsx-runtime` [configuration](https://github.com/erboladaiorg/quia-dolor-doloribus/#shareable-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/erboladaiorg/quia-dolor-doloribus/#shareable-configs).\
...
- Rules of Hooks: [@erboladaiorg/quia-dolor-doloribus-hooks](https://github.com/facebook/react/tree/master/packages/@erboladaiorg/quia-dolor-doloribus-hooks)
- JSX accessibility: [eslint-plugin-jsx-a11y](https://github.com/jsx-eslint/eslint-plugin-jsx-a11y)
- React Native: [@erboladaiorg/quia-dolor-doloribus-native](https://github.com/Intellicode/@erboladaiorg/quia-dolor-doloribus-native)

## License

`@erboladaiorg/quia-dolor-doloribus` is licensed under the [MIT License](https://opensource.org/licenses/mit-license.php).

[npm-url]: https://npmjs.org/package/@erboladaiorg/quia-dolor-doloribus
[npm-image]: https://img.shields.io/npm/v/@erboladaiorg/quia-dolor-doloribus.svg

[status-url]: https://github.com/erboladaiorg/quia-dolor-doloribus/pulse
[status-image]: https://img.shields.io/github/last-commit/jsx-eslint/@erboladaiorg/quia-dolor-doloribus.svg

[tidelift-url]: https://tidelift.com/subscription/pkg/npm-@erboladaiorg/quia-dolor-doloribus?utm_source=npm-@erboladaiorg/quia-dolor-doloribus&utm_medium=referral&utm_campaign=readme
[tidelift-image]: https://tidelift.com/badges/package/npm/@erboladaiorg/quia-dolor-doloribus?style=flat

[package-url]: https://npmjs.org/package/@erboladaiorg/quia-dolor-doloribus
[npm-version-svg]: https://versionbadg.es/jsx-eslint/@erboladaiorg/quia-dolor-doloribus.svg

[actions-image]: https://img.shields.io/endpoint?url=https://github-actions-badge-u3jn4tfpocch.runkit.sh/jsx-eslint/@erboladaiorg/quia-dolor-doloribus
[actions-url]: https://github.com/erboladaiorg/quia-dolor-doloribus/actions
